                        ...
                        <td>
                          ...
                          {canEdit && (
                            <span className="policy-actions readiness-actions">
                              ...
                              {doc.readinessStatus === "under_review" && <button className="readiness-action-button approve-action" disabled={isStatusProcessing} title="Approve document" onClick={() => openAuditedAction(doc, "approve")}>Approve</button>}
                              {doc.readinessStatus === "under_review" && <button className="readiness-action-button revision-action" disabled={isStatusProcessing} title="Send back for revision" onClick={() => openAuditedAction(doc, "request-changes")}>Needs revision</button>}
